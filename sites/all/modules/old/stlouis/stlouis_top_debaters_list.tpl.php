<?php
  ...
  if ($debate == 'Box') {
    ...
    $sql = 'select count(*) as count from users
      ...
      WHERE
      (debates_won > %d);';
    $result = db_query($sql, $game_user->debates_won);
...
<div class="$clan_class">
  ...
  <div class="opponent-influence">$exp<br/>$debates_lower won<br/>
...
firep($item);
    ...
    $sql = 'select count(*) as count from users
      ...
      WHERE
      (debates_won > %d);';
    $result = db_query($sql, $item->debates_won);
    $user_rank = db_fetch_object($result);
    $user_rank = $user_rank->count + 1;
