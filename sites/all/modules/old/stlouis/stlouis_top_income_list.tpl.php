<?php
  ...
  $data2 = $data = array();
    ...
    $sql = 'select count(*) as count from users
      ...
      WHERE
      (income - expenses) > %d;';
    $result = db_query($sql, $game_user->income - $game_user->expenses);
...
firep($item);
    ...
    $sql = 'select count(*) as count from users
      ...
      where fkey_neighborhoods_id = %d AND
      (income - expenses) > %d;';
    $result = db_query($sql, $game_user->fkey_neighborhoods_id, $exp);
...
<div class="$clan_class">
  ...
  <div class="opponent-influence">+$exp $game_user->values income / hr<br/>
