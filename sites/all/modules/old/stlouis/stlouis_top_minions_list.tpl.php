<?php
  ...
  $data3 = $data2 = $data = array();
    ...
    $sql = 'SELECT username, experience, initiative, endurance, 
      elocution, favors_completed, debates_lost, skill_points, luck,
    ...
    $sql .= '    
      ORDER by users.favors_completed DESC
      LIMIT 20;';
    ...
    $sql = 'select count(*) as count from users
      ...
      WHERE
      (favors_completed > %d);';
    $result = db_query($sql, $game_user->favors_completed);
...
<div class="$clan_class">
  ...
  <div class="opponent-influence">$exp<br/>
...
firep($item);
    ...
    $sql = 'select count(*) as count from users
      ...
      WHERE
      (favors_completed > %d);';
    $result = db_query($sql, $item->favors_completed);
    $user_rank = db_fetch_object($result);
    $user_rank = $user_rank->count + 1;
